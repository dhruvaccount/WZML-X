...
class _BotCommands:
    def __init__(self):
        ...
        self.StatusCommand = [f'status{CMD_SUFFIX}', 's', 'status', 'sall']
        self.UsersCommand = 'users'
        self.AuthorizeCommand = ['authorize', 'a']
        self.UnAuthorizeCommand = ['unauthorize', 'ua']
        self.AddBlackListCommand = ['blacklist', 'bl']
